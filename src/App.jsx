...
const ss = {
  ...
  th:     { background:"rgba(56,189,248,0.08)", padding:"9px 11px", textAlign:"left", fontWeight:600, color:C.accent, fontSize:10, textTransform:"uppercase", letterSpacing:"0.07em", borderBottom:`1px solid ${C.border}` },
  td:     (a) => ({ padding:"9px 11px", borderBottom:`1px solid rgba(255,255,255,0.04)`, background:a?"rgba(255,255,255,0.015)":"transparent" }),
    ...
    <div>
      ...
      <div style={{ borderRadius:12, border:`1px solid ${C.border}`, overflow:"auto", marginBottom:12 }}>
        <table style={{ borderCollapse:"collapse", width:"100%", tableLayout:"auto", minWidth:1800, fontSize:11 }}>
          <thead>
            <tr>
              <th colSpan={15} style={{ background:`${C.muted}88`, color:"#ffffff", fontSize:12, fontWeight:800, letterSpacing:"0.04em", border:`1px solid ${C.border}`, padding:"8px 10px", textAlign:"center" }}>{fYear ? fYear : "2026"}</th>
            </tr>
            <tr>
              <th colSpan={15} style={{ background:`${C.muted}88`, color:"#ffffff", fontSize:12, fontWeight:800, letterSpacing:"0.04em", border:`1px solid ${C.border}`, padding:"8px 10px", textAlign:"center" }}>{curLabel}</th>
            </tr>
            <tr>
              <th rowSpan={2} style={{ border:`1px solid ${C.border}`, padding:"8px 10px", textTransform:"uppercase", letterSpacing:"0.06em", fontSize:10, textAlign:"center" }}>No</th>
              <th rowSpan={2} style={{ border:`1px solid ${C.border}`, padding:"8px 10px", textTransform:"uppercase", letterSpacing:"0.06em", fontSize:10, textAlign:"center" }}>Nama Kapal</th>
              <th colSpan={5} style={{ border:`1px solid ${C.border}`, padding:"8px 10px", textTransform:"uppercase", letterSpacing:"0.06em", fontSize:10, textAlign:"center" }}>Activity</th>
              <th colSpan={6} style={{ border:`1px solid ${C.border}`, padding:"8px 10px", textTransform:"uppercase", letterSpacing:"0.06em", fontSize:10, textAlign:"center" }}>Konsumsi BBM (Litre)</th>
              <th colSpan={4} style={{ border:`1px solid ${C.border}`, padding:"8px 10px", textTransform:"uppercase", letterSpacing:"0.06em", fontSize:10, textAlign:"center" }}>Performance + AVG Speed</th>
            </tr>
            <tr>
              <th style={{ border:`1px solid ${C.border}`, padding:"7px 9px", textTransform:"uppercase", letterSpacing:"0.05em", fontSize:9, textAlign:"center" }}>Anchorage (Hari)</th>
              <th style={{ border:`1px solid ${C.border}`, padding:"7px 9px", textTransform:"uppercase", letterSpacing:"0.05em", fontSize:9, textAlign:"center" }}>At Port (Hari)</th>
              <th style={{ border:`1px solid ${C.border}`, padding:"7px 9px", textTransform:"uppercase", letterSpacing:"0.05em", fontSize:9, textAlign:"center" }}>Downtime (Hari)</th>
              <th style={{ border:`1px solid ${C.border}`, padding:"7px 9px", textTransform:"uppercase", letterSpacing:"0.05em", fontSize:9, textAlign:"center" }}>Total (Hari)</th>
              <th style={{ border:`1px solid ${C.border}`, padding:"7px 9px", textTransform:"uppercase", letterSpacing:"0.05em", fontSize:9, textAlign:"center" }}>Laut (NM)</th>
              <th style={{ border:`1px solid ${C.border}`, padding:"7px 9px", textTransform:"uppercase", letterSpacing:"0.05em", fontSize:9, textAlign:"center" }}>ME ({prevLabel})</th>
              <th style={{ border:`1px solid ${C.border}`, padding:"7px 9px", textTransform:"uppercase", letterSpacing:"0.05em", fontSize:9, textAlign:"center" }}>AE at Sea ({prevLabel})</th>
              <th style={{ border:`1px solid ${C.border}`, padding:"7px 9px", textTransform:"uppercase", letterSpacing:"0.05em", fontSize:9, textAlign:"center" }}>AE at Port ({prevLabel})</th>
              <th style={{ border:`1px solid ${C.border}`, padding:"7px 9px", textTransform:"uppercase", letterSpacing:"0.05em", fontSize:9, textAlign:"center" }}>ME ({curLabel})</th>
              <th style={{ border:`1px solid ${C.border}`, padding:"7px 9px", textTransform:"uppercase", letterSpacing:"0.05em", fontSize:9, textAlign:"center" }}>AE at Sea ({curLabel})</th>
              <th style={{ border:`1px solid ${C.border}`, padding:"7px 9px", textTransform:"uppercase", letterSpacing:"0.05em", fontSize:9, textAlign:"center" }}>AE at Port ({curLabel})</th>
              <th style={{ border:`1px solid ${C.border}`, padding:"7px 9px", textTransform:"uppercase", letterSpacing:"0.05em", fontSize:9, textAlign:"center" }}>AVG Speed {prevLabel}</th>
              <th style={{ border:`1px solid ${C.border}`, padding:"7px 9px", textTransform:"uppercase", letterSpacing:"0.05em", fontSize:9, textAlign:"center" }}>AVG Speed {curLabel}</th>
            </tr>
          </thead>
          <tbody>
            {SHIPS.map((ship, idx)=>(
              <tr key={ship}>
                <td style={{ textAlign:"center", border:`1px solid ${C.border}`, padding:"6px 8px" }}>{idx+1}</td>
                <td style={{ textAlign:"left", whiteSpace:"nowrap", minWidth:130, border:`1px solid ${C.border}`, padding:"6px 8px", fontWeight:600 }}>{ship}</td>
                <td style={{ border:`1px solid ${C.border}`, padding:"6px 8px" }}></td>
                <td style={{ border:`1px solid ${C.border}`, padding:"6px 8px" }}></td>
                <td style={{ border:`1px solid ${C.border}`, padding:"6px 8px" }}></td>
                <td style={{ border:`1px solid ${C.border}`, padding:"6px 8px" }}></td>
                <td style={{ border:`1px solid ${C.border}`, padding:"6px 8px" }}></td>
          ...
          <tfoot>
            <tr>
              <td colSpan={2} style={{ textAlign:"center", border:`1px solid ${C.border}`, padding:"7px 9px" }}>TOTAL</td>
