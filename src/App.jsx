...
const ss = {
  ...
  tbl:    { width:"100%", borderCollapse:"collapse", fontSize:11, border:`1px solid ${C.border}` },
  th:     { background:"rgba(56,189,248,0.18)", padding:"9px 11px", textAlign:"center", fontWeight:700, color:C.accent, fontSize:10, textTransform:"uppercase", letterSpacing:"0.07em", border:`1px solid ${C.border}` },
  td:     (a) => ({ padding:"9px 11px", textAlign:"center", border:`1px solid ${C.border}`, background:a?"rgba(255,255,255,0.02)":"transparent" }),
